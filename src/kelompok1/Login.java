...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(password.contains("1234")&& user.contains("indrabyz")){
        usertextfield.setText("");
        passwordtextfield.setText("");
        JOptionPane.showMessageDialog(null, "SELAMAT DATANG DI WARUNG");
        close();
        Menu w = new Menu();
        w.setVisible(true); 
      }else{
            JOptionPane.showMessageDialog(null,"PASSWORD SALAH GOBLOK !\nMAU HACK YAAAA?","Wrong Pass",JOptionPane.ERROR_MESSAGE);
            usertextfield.setText("");
            passwordtextfield.setText("");
